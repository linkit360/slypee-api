...
class MainController extends ActiveController
{
    ...
    public function actionIndex() {
        ...
        $categories = Category::find()->select(["id", "name"])->andWhere([">", "content", 0])->andWhere(["=", "main_page", 1])->andWhere(["=", "active", 1])->orderBy("priority")->all();
        ...
        foreach ($categories as $category) {
            ...
            foreach ($items as $item){
                $prepared_items[] = $item->prepareForListApi();
            }
