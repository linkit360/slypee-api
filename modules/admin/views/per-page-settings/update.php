...
$this->title = "Set per page ".$model->name." value";
$this->params['breadcrumbs'][] = ['label' => 'Pagination settings', 'url' => ['pagination/'], 'class' => 'breadcrumb'];
...
<?php $form = ActiveForm::begin([
    ...
    'fieldConfig' => [
        'template' => "<div class=\"row\"><div class=\"input-field indigo-field\">{input}</div></div>",
