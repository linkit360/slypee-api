                ...
                <td>
                    <div class="dropdown-wrapper">
                        ...
                        <ul class="dropdown-content" id="dropdown<?= $user->id ?>">
                            ...
                            <li>
                                <a href="<?=Url::to(['customers/update', 'id' => $user->id]);?>" class="nowrap"><i class="material-icons left">edit</i>Update</a>
                            </li>
                            <li>
                                <a href="<?=Url::to(['customers/activate', 'id' => $user->id]);?>" class="nowrap"><i class="material-icons left">check</i><?= $user->active ? "Deactivate" : "Activate"?></a>
                            </li>
                            <li>
                                <a href="<?=Url::to(['log/', 'type' => 'customer', 'object_id' => $user->id]);?>" class="nowrap"><i class="material-icons left">history</i>History</a>
                            </li>
                        </ul>
                    </div>
                </td>
